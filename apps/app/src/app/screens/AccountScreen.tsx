        ...
        <Animated.View entering={enterSection(4)}>
          ...
          <View style={{ gap: 10 }}>
            ...
            <Accordion title="Terms summary">
              ...
              <Text style={bullet}>• Both sides put up a refundable deposit (5% of the deal, min $5) to show up. Head out and then bail — or never show — and most of it goes to the person you stood up (MeetMe keeps a small recovery fee).</Text>
              <Text style={bullet}>• Sellers never pay upfront: a card on file, with the deposit held only at head-out.</Text>
